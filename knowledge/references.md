...
- [AWS Prescriptive Guidance](https://docs.aws.amazon.com/prescriptive-guidance/latest/guides/) -- opinionated patterns and guides for common cloud scenarios
...
- **Databases** -- [Database architectures](https://aws.amazon.com/architecture/databases/), [Aurora Global Database](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-global-database.html), [Database migration patterns](https://docs.aws.amazon.com/prescriptive-guidance/latest/migration-databases/)
- **Compute** -- [Compute architectures](https://aws.amazon.com/architecture/compute/), [Spot best practices](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-best-practices.html), [EC2 Image Builder](https://docs.aws.amazon.com/imagebuilder/latest/userguide/what-is-image-builder.html)
- **Caching** -- [ElastiCache best practices](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/best-practices.html), [Caching strategies](https://docs.aws.amazon.com/prescriptive-guidance/latest/caching-strategies/)
- **Edge & CDN** -- [CloudFront origin failover](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/high_availability_origin_failover.html), [WAF Security Automations](https://aws.amazon.com/solutions/implementations/security-automations-for-aws-waf/), [DDoS mitigation](https://docs.aws.amazon.com/prescriptive-guidance/latest/ddos-mitigation/)
...
- **Data** -- [Data architecture guide](https://learn.microsoft.com/en-us/azure/architecture/data-guide/), [Azure SQL HA](https://learn.microsoft.com/en-us/azure/architecture/databases/architecture/azure-sql-database-high-availability), [Cosmos DB multi-region](https://learn.microsoft.com/en-us/azure/architecture/solution-ideas/articles/globally-distributed-mission-critical-applications-using-cosmos-db)
- **Security** -- [Security architectures](https://learn.microsoft.com/en-us/azure/architecture/security/), [Landing Zone security](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/ready/landing-zone/design-area/security), [Identity architectures](https://learn.microsoft.com/en-us/azure/architecture/identity/)
...
- **Networking** -- [Networking architectures](https://cloud.google.com/architecture#networking), [Hub-and-spoke design](https://cloud.google.com/architecture/hub-spoke-network-architecture), [Hybrid/multi-cloud topologies](https://cloud.google.com/architecture/hybrid-and-multi-cloud-network-topologies), [Cloud Armor best practices](https://cloud.google.com/armor/docs/best-practices)
- **Compute** -- [Compute architectures](https://cloud.google.com/architecture#compute), [Compute Engine best practices](https://cloud.google.com/compute/docs/best-practices), [Scalable web apps on Compute Engine](https://cloud.google.com/architecture/scalable-and-resilient-apps)
- **Data** -- [Database architectures](https://cloud.google.com/architecture#databases), [Spanner reference architectures](https://cloud.google.com/spanner/docs/reference-architectures), [Cloud SQL HA](https://cloud.google.com/sql/docs/mysql/high-availability), [Bigtable schema design](https://cloud.google.com/bigtable/docs/schema-design)
- **Security** -- [Security architectures](https://cloud.google.com/architecture#security), [VPC Service Controls best practices](https://cloud.google.com/vpc-service-controls/docs/best-practices), [Security Command Center](https://cloud.google.com/security-command-center/docs/concepts-security-command-center-overview)

## Nutanix

### Portals

- [Nutanix Validated Designs](https://www.nutanix.com/go/validated-designs) -- vendor-validated architectures for enterprise applications
- [Nutanix Reference Architecture Library](https://www.nutanix.com/resources/reference-architectures) -- tested architectures for databases, EUC, DevOps, and hybrid cloud
- [The Nutanix Bible](https://www.nutanix.com/go/the-nutanix-bible) -- comprehensive architecture guide for the Nutanix Cloud Platform
...
- [DR and Business Continuity designs](https://www.nutanix.com/resources/reference-architectures) -- Leap-based disaster recovery and metro availability validated designs
