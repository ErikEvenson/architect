...
- [Microsoft 365 Documentation](https://learn.microsoft.com/microsoft-365/) -- tenant setup, Exchange Online, SharePoint, Teams, and compliance features
- [Microsoft 365 Licensing](https://learn.microsoft.com/microsoft-365/enterprise/microsoft-365-overview) -- E3/E5 feature comparison, add-ons, and frontline worker licensing
- [Conditional Access Policies](https://learn.microsoft.com/entra/identity/conditional-access/overview) -- MFA enforcement, device compliance, location-based access, and session controls
