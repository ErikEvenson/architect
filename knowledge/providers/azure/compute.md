...
- [Azure Landing Zone: Compute](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/ready/landing-zone/design-area/compute) -- Cloud Adoption Framework guidance for compute platform selection and scaling
