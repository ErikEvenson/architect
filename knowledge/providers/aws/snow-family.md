...
- [ ] Select the appropriate device: Snowcone (8TB HDD or 14TB SSD, 2 vCPUs, 4GB RAM — ultraportable at 4.5 lbs), Snowball Edge Storage Optimized (80TB usable, 40 vCPUs, 80GB RAM — for large data transfers), or Snowball Edge Compute Optimized (42TB usable, 104 vCPUs, 416GB RAM, optional NVIDIA V100 GPU — for heavy edge compute and ML inference)
...
### Data transfer method: S3 API vs. NFS vs. DataSync
...
### Short-term job vs. long-term lease
