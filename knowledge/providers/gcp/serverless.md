...
Cloud Run (services, jobs, functions), Cloud Functions (1st gen legacy, 2nd gen built on Cloud Run), Cloud Run Functions (rebranded Cloud Functions), Eventarc, Pub/Sub, Cloud Tasks, Workflows, Cloud Scheduler, serverless compute patterns.

## Checklist

- [ ] [Recommended] Is Cloud Run Functions (formerly Cloud Functions 2nd gen, built on Cloud Run) used instead of 1st gen for new deployments, providing concurrency support, longer timeouts (60 min), larger instances (32 GB RAM, 8 vCPU), and traffic splitting?
