...
- **VMware NSX Design Guide**: [VMware Validated Designs](https://core.vmware.com/vmware-validated-solutions) -- microsegmentation, distributed firewall rules, and network overlay architecture (reference even for non-VMware environments)
