...
- [ISO/IEC 27001:2022](https://www.iso.org/standard/27001) — official standard for information security management systems
- [ISO/IEC 27002:2022](https://www.iso.org/standard/75652.html) — guidance on implementing Annex A controls from ISO 27001
- [CSA STAR Registry](https://cloudsecurityalliance.org/star/registry/) — public registry of cloud provider security assessments and certifications
...
- `compliance/soc2.md` — SOC 2 Trust Service Criteria (often pursued alongside ISO 27001)
- `compliance/csa-ccm.md` — CSA CCM controls (maps to ISO 27001 Annex A)
