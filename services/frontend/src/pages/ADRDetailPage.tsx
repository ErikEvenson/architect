...
export function ADRDetailPage() {
  ...
  if (!adr) return <div className="text-gray-500">Loading...</div>;
    ...
    <div className="max-w-3xl">
      ...
      <div className="space-y-6">
        <section className="bg-white p-4 rounded-lg border border-gray-200">
          <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">Context</h2>
          <p className="text-gray-800 whitespace-pre-wrap">{adr.context}</p>
        </section>

        <section className="bg-white p-4 rounded-lg border border-gray-200">
          <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">Decision</h2>
          <p className="text-gray-800 whitespace-pre-wrap">{adr.decision}</p>
        </section>

        <section className="bg-white p-4 rounded-lg border border-gray-200">
          <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">Consequences</h2>
          <p className="text-gray-800 whitespace-pre-wrap">{adr.consequences}</p>
        </section>
